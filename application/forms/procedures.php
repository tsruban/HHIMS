...
//pager starts
$form["CAPTION"]  = "SNOMED Procedures ";
$form["ACTION"]  = base_url()."index.php/form/edit/procedures/";
$form["ROW_ID"]="PROCEDUREID";
$form["COLUMN_MODEL"] = array( 'PROCEDUREID'=>array("width"=>"35px"), 'CONCEPTID', 'TERM');
$form["ORIENT"] = "L";
$form["LIST"] = array( 'PROCEDUREID', 'CONCEPTID', 'TERM');
