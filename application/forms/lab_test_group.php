...
//pager starts
$form["CAPTION"]  = "Lab test group <input type=\'button\' class=\'btn btn-xs btn-success\' onclick=self.document.location=\'".site_url('form/create/lab_test_group')."\' value=\'Add new\'>";
$form["ACTION"]  = base_url()."index.php/form/edit/lab_test_group/";
...
$form["DISPLAY_LIST"] = array( 'LABGRPTID', 'Name', 'Active');
//pager ends	
$form["FLD"]=array(
array(		
		"id"=>"Name", 
