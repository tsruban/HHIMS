...
$form = array();
$form["OBJID"] = "ADMNOTEID";
$form["TABLE"] = "admission_notes";
$form["SAVE"] = "";
$form["SAVE_TABLE"] = "";
...
$form["FORM_CAPTION"] = "In-Patient nursing";
//pager starts
$form["CAPTION"]  = "In-Patient nursing";
$form["ACTION"]  = base_url()."index.php/form/edit/admission_notes/";
$form["ROW_ID"]="ADMNOTEID";
$form["COLUMN_MODEL"] = array();
$form["ORIENT"] = "L";
$form["LIST"] = array( 'ADMNOTEID');
