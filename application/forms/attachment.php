...
$form["FORM_CAPTION"] = "Attach file to the medical record";
//pager starts
$form["CAPTION"]  = "Attach file to the medical record";
$form["ACTION"]  = base_url()."index.php/form/edit/attachment/";
$form["ROW_ID"]="ATTCHID";
$form["COLUMN_MODEL"] = array();
$form["ORIENT"] = "L";
$form["LIST"] = array( 'ATTCHID');
...
array(		
		"id"=>"Attach_Type", 
		"name"=>"Attach_Type",
		"label"=>"*Attachent type",
		"type"=>"select",
		"value"=>"",
		"option"=>array("X-Ray","ECG","Scan Image","PDF","Other"),
		"placeholder"=>"",
	...
	array(		
		"id"=>"Attach_To", 
		"name"=>"Attach_To",
		"label"=>"*Attach file to",
		"type"=>"select",
		"value"=>"",
		"option"=>array("Patient"),
		"placeholder"=>"",
		"rules"=>"required|xss_clean",
		"class"=>"input",
		"style"=>""
