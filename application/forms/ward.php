...
//pager starts
$form["CAPTION"]  = "Ward <input type=\'button\' class=\'btn btn-xs btn-success\' onclick=self.document.location=\'".site_url('form/create/ward')."\' value=\'Add new\'>";
...
$form["DISPLAY_LIST"] = array( 'WID','Name', 'BedCount', 'Telephone');
//pager ends	
$form["FLD"]=array(
array(		
		"id"=>"Name", 
