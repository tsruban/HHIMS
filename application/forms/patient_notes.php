...
$form = array();
$form["OBJID"] = "patient_notes_id";
$form["TABLE"] = "patient_notes";
$form["SAVE"] = "";
$form["SAVE_TABLE"] = "";
...
$form["ACTION"]  = base_url()."index.php/form/edit/patient_notes/";
$form["ROW_ID"]="patient_notes_id";
$form["COLUMN_MODEL"] = array();
$form["ORIENT"] = "L";
$form["LIST"] = array( 'patient_notes_id');
$form["DISPLAY_LIST"] = array( 'ID');
//pager ends	
$form["LEFT_BAR"][0] = array('title'=>'Previous Notes','id'=>'previous_notes','run_function'=>"patient/get_previous_notes_list",'param'=>$this->uri->segment(4));
