...
<div class="container" style="width:95%;">
	...
	<div class="col-md-12 " >
		...
		<div class="panel panel-default  "  style="padding:2px;margin-bottom:1px;" >
			<div class="panel-heading" ><b><?php echo isset($clinic_info["name"])?$clinic_info["name"]:""; ?> Prescription</b>
				<?php
				if (!empty($stock_info)){
					echo '<br>will use '. $stock_info["name"].' stock';
				}
				?>
			</div>
			<div class="" style="margin-bottom:1px;padding-top:8px;">
				<?php 
					...
					if (isset($prescribe_items_list)){
						...
						echo '</tr>';
							...
							//print_r($prescribe_items_list[$i]);
								echo '<tr>';
									...
									echo '</td>';
									echo '<td>';
									if ($clinic_presciption_info["Status"] == "Draft") {
						...
						echo '<a href="'.site_url("clinic/open/".$clinic_patient_info["clinic_patient_id"]).'" type="button" class="btn  pull-left btn-warning btn-xs"  >Back to visit</a>';
						...
						if (count($prescribe_items_list)>0){
							...
							echo '<button type="button" class="btn pull-right btn-success btn-xs" onclick=send_to_pharmacy("'.$clinic_presciption_info["clinic_prescription_id"].'","'.$clinic_patient_info["clinic_patient_id"].'"); >Send to pharmacy</button>';
						}
					}
				?>				
			</div><br><br>
				...
				<tr id="blk_2_tr">
					<td id="blk_2">
						...
						<form id="drug_form" method="POST" action="<?php echo site_url("clinic/save_prescription"); ?>" >
							...
							<input type="hidden" name="clinic_patient_id" id="clinic_patient_id" value="<?php echo $clinic_patient_info["clinic_patient_id"]; ?>">
