...
<body >
    <div class="container">
		<form class="form-signin" action="<?php echo base_url(); ?>index.php/login/auth" method="post" accept-charset="utf-8">
			...
			Licensed to: <a href="javascript:void(0)"><?php echo isset($_SESSION["LIC_HOS"])?$_SESSION["LIC_HOS"]:"----";  ?></a>
			<button class="btn btn-lg btn-primary btn-block" type="submit">Log in</button>
			<input type="hidden" name='LIC' id="LIC" value="<?php echo isset($_SESSION["LIC"])?$_SESSION["LIC"]:""; ?>" >        
			<input type="hidden" name='continue' id="continue" value="<?php echo $continue; ?>" >  
			<input type="hidden" name='LIC_HOS' id="LIC_HOS" value="<?php echo isset($_SESSION["LIC_HOS"])?$_SESSION["LIC_HOS"]:""; ?>" >
      </form>
	</div>
  <!-- /container -->
		...
		<div class="text-center">
			<div >Visit <a href="http://www.hhims.org" target="_blank" ><b>www.hhims.org</b></a> for more details..</div><br>
			 ...
			 <a href='http://www.lunartechnologies.net' target='_blank'><img src="<?php echo base_url(); ?>images/lt_logo_tr_100.png" width=40 height=40 ></a>
				<br/>ICPC is copyright property of the World Organization of Family Doctors (Wonca).
		</div>
	</div>	
	<div class="col-md-6 ">		
		<ul>
