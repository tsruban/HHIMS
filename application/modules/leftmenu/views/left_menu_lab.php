      ...
      // $mdsPermission = MDSPermission::GetInstance();
           ...
           $menu .="<div id='left-sidebar1' style='position:fixed1;'>\n";
			$menu .="<div class='list-group'>";
			  ...
			  $menu .="<a href='".base_url()."index.php/search/lab_orders/ADM' class='list-group-item'>Admission Lab Orders</a>";
			  $menu .="<a href='".base_url()."index.php/search/lab_orders/CLN' class='list-group-item'>Clinic Lab Orders</a>";
			  $menu .="<a href='".base_url()."index.php/search/sample_order' class='list-group-item'>Collection Room</a>";
			$menu .="</div>";
