           ...
           $menu .="<div id='left-sidebar1' style='position:fixed1;'>\n";
				$menu .="<div class='list-group'>";
				  $menu .="<a href='' class='list-group-item active'>";
					$menu .="Commands";
				  $menu .="</a>";
				  $menu .="<a href='".base_url()."index.php/clinic/open/".$clinic_patient_info["clinic_patient_id"]."' class='list-group-item'><span class='glyphicon glyphicon-user'></span>&nbsp;Clinic overview</a>";
				 ...
				 // $menu .="<a href='".base_url()."index.php/form/create/patient_alergy/".$pid."/?CONTINUE=clinic/open/".$clinic_patient_info["clinic_patient_id"]."' class='list-group-item'><span class='glyphicon glyphicon-bell'></span>&nbsp;Add Allergy</a>";
				  ...
				  $menu .="<a href='".base_url()."index.php/clinic/close/".$clinic_patient_info["clinic_patient_id"]."/".$pid."?CONTINUE=clinic/open/".$clinic_patient_info["clinic_patient_id"]."' class='list-group-item'><span class='glyphicon glyphicon-stop'></span>&nbsp;Close this clinic</a>";
				...
				$menu .="<div class='list-group'>";
				  ...
				  if (isset($module)&&count($module)>0){
					for($i=0; $i<count($module); ++$i){
						$menu .=" <a ";
						$menu .=" href='".base_url()."index.php/questionnaire/load/".$module[$i]["qu_questionnaire_id"]."/".$pid."/clinic_patient/".$clinic_patient_info["clinic_patient_id"]."?CONTINUE=clinic/new_visit/".$clinic_patient_info["clinic_patient_id"]."/".$pid."' ";
