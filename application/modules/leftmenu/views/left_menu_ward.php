           ...
           $menu .="<div id='left-sidebar1' style='position:fixed1;'>\n";
			$menu .="<div class='list-group'>";
			  $menu .="<a href='' class='list-group-item active'>";
				$menu .="Commands";
			  $menu .="</a>";
				$menu .="<a href='".base_url()."index.php/ward/view/".$wid."' class='list-group-item'>Current patient list</a>";
				$menu .="<a href='".base_url()."index.php/ward/nurse_chart/".$wid."' class='list-group-item'>Nursing drug chart</a>";
				$menu .="<a href='".base_url()."index.php/ward/view/".$wid."/discharged' class='list-group-item'>Discharged patient list</a>";
			$menu .="</div>";
			$menu .="<div class='list-group'>";
			  $menu .="<a href='' class='list-group-item active'>";
				$menu .="Reports";
