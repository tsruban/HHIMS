...
<div style="width:95%;">
    <div class="row" style="margin-top:55px;">
        <div class="col-md-2 ">
            <?php echo Modules::run('leftmenu/registry'); //runs the available left menu for  ?>
        </div>
        <div class="col-md-10 ">
            <div class="panel panel-default">
                ...
                echo "<td class='ttll' colspan=5  ><img src='".base_url()."/images/sl_logo_black_white.png' valign=middle>&nbsp;&nbsp;&nbsp;&nbsp;$caption2</td>";
